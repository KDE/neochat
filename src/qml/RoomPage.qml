...
Kirigami.Page {
    ...
    Connections {
        ...
        function onShowMessageMenu(eventId, author, delegateType, plainText, htmlText, selectedText, isThread) {
        ...
        function onShowFileMenu(eventId, author, delegateType, plainText, mimeType, progressInfo, isThread) {
