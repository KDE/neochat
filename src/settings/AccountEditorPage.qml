...
FormCard.FormCardPage {
    ...
    readonly property bool hasUnsavedChanges: root.connection.localUser.displayName !== name.text
        ...
        || timezoneField !== timezoneLabel.textValue;
    property string timezoneField: root.connection.profileField("m.tz")
    ...
    function saveChanges(): void {
        ...
        if (root.connection.profileField("m.tz") !== timezoneLabel.textValue) {
            ...
            timezoneField = root.connection.profileField("m.tz"); // Update binding
        }
    }
