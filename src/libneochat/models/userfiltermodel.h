...
private:
    ...
    // Default to Join as to not break existing consumers of this, and because in libQuotient 0.9.x we can't even set the property that controls this...
    Quotient::Membership m_membership = Quotient::Membership::Join;
};
