    ...
    RowLayout {
        ...
        RowLayout {
            ...
            QQC2.ToolButton {
                ...
                onClicked: {
                    root.documentHandler.bold = checked;
                }
            ...
            QQC2.ToolButton {
                ...
                onClicked: {
                    root.documentHandler.italic = checked;
                }
            ...
            QQC2.ToolButton {
                ...
                onClicked: {
                    root.documentHandler.underline = checked;
                }
            ...
            QQC2.ToolButton {
                ...
                onClicked: {
                    root.documentHandler.strikethrough = checked;
                }
        ...
        QQC2.ToolButton {
            ...
            QQC2.Menu {
                ...
                QQC2.MenuItem {
                    icon.name: "format-text-bold"
                    text: i18nc("@action:button", "Bold")
                    onTriggered: root.documentHandler.bold = !root.documentHandler.bold;
                }
                QQC2.MenuItem {
                    icon.name: "format-text-italic"
                    text: i18nc("@action:button", "Italic")
                    onTriggered: root.documentHandler.italic = !root.documentHandler.italic;
                }
                QQC2.MenuItem {
                    icon.name: "format-text-underline"
                    text: i18nc("@action:button", "Underline")
                    onTriggered: root.documentHandler.underline = !root.documentHandler.underline;
                }
                QQC2.MenuItem {
                    icon.name: "format-text-strikethrough"
                    text: i18nc("@action:button", "Strikethrough")
                    onTriggered: root.documentHandler.strikethrough = !root.documentHandler.strikethrough;
                }
            }
