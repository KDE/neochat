            ...
            FormCard.FormCard {
                ...
                Repeater {
                    ...
                    delegate: FormCard.FormButtonDelegate {
                        ...
                        text: modelData//QmlUtils.escapeString(connection.localUser.displayName)
                        description: connection.localUser.id
                        leadingPadding: Kirigami.Units.largeSpacing

                        onClicked: {
                            let pending = Accounts.loadAccount(modelData);
                            pending.ready.connect(() => {
                                Controller.activeConnection = pending.connection();
