...
void Server::start()
{
    ...
    m_server.route(u"/_matrix/media/v3/download/<arg>/<arg>"_s,
                   QHttpServerRequest::Method::Get,
                   [](const QString &serverName, const QString &mediaId, QHttpServerResponder &responder, const QHttpServerRequest &request) {
