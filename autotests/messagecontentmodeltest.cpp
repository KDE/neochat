...
void MessageContentModelTest::missingEvent()
{
    ...
    QCOMPARE(model1.data(model1.index(0), MessageContentModel::BlockRole).value<Blocks::BasicTextBlock *>()->display(), u"Loading…"_s);
    ...
    QCOMPARE(model2.data(model1.index(0), MessageContentModel::BlockRole).value<Blocks::BasicTextBlock *>()->display(), u"Loading reply…"_s);
