...
void EventHandlerTest::mediaInfo()
{
    ...
    auto fileBlock = EventHandler::blockForMediaEvent(room, event, this);
    auto videoBlock = dynamic_cast<Blocks::VideoBlock *>(fileBlock);
...
{
#ifdef Q_OS_WINDOWS
    QTest::ignoreMessage(QtWarningMsg, "EventHandler::blockForMediaEvent called with room set to nullptr.");
#else
    QTest::ignoreMessage(QtWarningMsg, "blockForMediaEvent called with room set to nullptr.");
#endif
    QCOMPARE(EventHandler::blockForMediaEvent(nullptr, nullptr, this), nullptr);

#ifdef Q_OS_WINDOWS
    QTest::ignoreMessage(QtWarningMsg, "EventHandler::blockForMediaEvent called with event set to nullptr.");
#else
    QTest::ignoreMessage(QtWarningMsg, "blockForMediaEvent called with event set to nullptr.");
#endif
    QCOMPARE(EventHandler::blockForMediaEvent(room, nullptr, this), nullptr);
}
